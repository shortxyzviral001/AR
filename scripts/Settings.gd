...
const TRANSLATIONS: Dictionary = {
	"fr": {
		...
		"lb_back": "Retour",
		# Tutorial
		"tutorial_title": "Bienvenue, Veilleur !",
		...
		"tutorial_step3": "Recolte les etoiles jaunes pour raviver les astres (score + cristaux), evite les meteores et les malus violets/jaunes.",
		"tutorial_step4": "Des eclaireurs corrompus par l'Eclipse apparaissent : ton tir les detruit automatiquement, ou tu peux les esquiver.",
		"tutorial_step5": "Toutes les ~40 secondes, un gardien corrompu attaque avec sa propre barre de vie et un pattern de tir signature.",
		"tutorial_step6": "Enchaine les recoltes sans etre touche pour faire grimper ton multiplicateur de combo.",
		"tutorial_step7": "AURA, ton esprit-guide, peut activer une capacite speciale en combat : appuie sur son icone quand elle est prete.",
		"tutorial_step8": "Chaque coque de vaisseau a un vrai trait de jeu (esquive, tir, vitesse) : choisis-la avec soin dans la Boutique.",
		...
		# Cinematics
		"cine_welcome": "BIENVENUE, VEILLEUR",
		"cine_subtitle": "Une etoile t'attend...",
		"cine_boss_warning": "ALERTE",
		"cine_boss_approach": "Un gardien corrompu approche...",
		"cine_prepare": "Prepare-toi a raviver la lumiere !",
		"cine_fly_safe": "Veille bien, Veilleur.",
		# Story cinematics
		"story_skip": "Passer",
		"cine_nova_name": "AURA",
		"cine_pilot_name": "VEILLEUR",
		"cine_scourge_name": "L'ECLIPSE",
		"cine_line_1a": "Veilleur... cette etoile faiblit. Ravive-la avant qu'elle ne s'eteigne.",
		"cine_line_1b": "Chaque cristal que tu recoltes redonne vie a une etoile mourante. C'est notre serment.",
		"cine_line_1c": "Mais regarde la-bas... cette ombre qui grandit. Je ne l'avais jamais vue aussi proche.",
		"cine_line_2a": "Veilleur ! Une etoile entiere vient de s'eteindre... en un instant !",
		"cine_line_2b": "C'est elle. L'Eclipse. Elle ne meurt pas de vieillesse, elle est... devoree.",
		"cine_line_2c": "Elle a deja englouti trois constellations. Aucun Veilleur n'en est revenu.",
		"cine_line_3a": "Si elle atteint le Coeur de la Galaxie, plus aucune etoile ne brillera. Jamais.",
		"cine_line_3b": "Veilleur... tu es la derniere lumiere encore allumee. Le dernier de notre ordre.",
		"cine_line_4a": "Alors on ravive. On repousse l'ombre. Et on garde les etoiles allumees.",
		"cine_title_main": "ASTRO RECOLTE",
		"cine_title_sub": "Les Veilleurs d'Etoiles",
		"cine_tap_hint": "Touchez pour continuer",
		# Zone transitions
		"zone_intro_0": "Constellation Bleue — Le sas d'entree du Veilleur",
		"zone_intro_1": "Nebuleuse Violette — Les murmures de l'ombre",
		"zone_intro_2": "Constellation Ambree — Les etoiles vacillent",
		"zone_intro_3": "Voile Cramoisi — Le seuil de l'Eclipse",
		"zone_intro_4": "Abysses Emeraude — Le dernier rempart",
		"sector_word": "SECTEUR",
		"cycle_word": "Cycle",
	},
	...
	"en": {
		...
		"tutorial_step3": "Gather yellow stars to rekindle them (score + crystals), avoid meteors and purple/yellow debuffs.",
		"tutorial_step4": "Scouts corrupted by the Eclipse appear: your shots destroy them automatically, or you can dodge them.",
		"tutorial_step5": "Every ~40 seconds, a corrupted guardian arrives with its own health bar and signature attack pattern.",
		"tutorial_step6": "Chain rescues without getting hit to build up your combo multiplier.",
		"tutorial_step7": "AURA, your guiding spirit, can trigger a special ability in battle: tap her icon when it's ready.",
		"tutorial_step8": "Every hull has a real gameplay trait (dodge, fire rate, speed): choose wisely in the Shop.",
		...
		# Cinematics
		"cine_welcome": "WELCOME, WARDEN",
		"cine_subtitle": "A star awaits...",
		"cine_boss_warning": "WARNING",
		"cine_boss_approach": "A corrupted guardian approaches...",
		"cine_prepare": "Prepare to rekindle the light!",
		"cine_fly_safe": "Watch well, Warden.",
		# Story cinematics
		"story_skip": "Skip",
		"cine_nova_name": "AURA",
		"cine_pilot_name": "WARDEN",
		"cine_scourge_name": "THE ECLIPSE",
		"cine_line_1a": "Warden... this star is fading. Rekindle it before it goes dark.",
		"cine_line_1b": "Every crystal you gather brings a dying star back to life. That is our oath.",
		"cine_line_1c": "But look, over there... that shadow keeps growing. I've never seen it this close.",
		"cine_line_2a": "Warden! An entire star just went out... in an instant!",
		"cine_line_2b": "It's her. The Eclipse. She doesn't fade with age, she is... devoured.",
		"cine_line_2c": "She has already swallowed three constellations. No Warden ever returned.",
		"cine_line_3a": "If she reaches the Heart of the Galaxy, no star will ever shine again.",
		"cine_line_3b": "Warden... you are the last light still burning. The last of our order.",
		"cine_line_4a": "Then we rekindle. We push back the shadow. And we keep the stars alight.",
		"cine_title_main": "ASTRO HARVEST",
		"cine_title_sub": "The Star Wardens",
		"cine_tap_hint": "Tap to continue",
		# Zone transitions
		"zone_intro_0": "Blue Constellation — The Warden's gateway",
		"zone_intro_1": "Violet Nebula — Whispers of the shadow",
		"zone_intro_2": "Amber Constellation — The stars flicker",
		"zone_intro_3": "Crimson Veil — The threshold of the Eclipse",
		"zone_intro_4": "Emerald Abyss — The last bastion",
		"sector_word": "SECTOR",
		"cycle_word": "Cycle",
	},
}
